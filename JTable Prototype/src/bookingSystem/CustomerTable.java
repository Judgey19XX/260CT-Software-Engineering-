...
public class CustomerTable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblCustomers.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CustomerID", "First Name", "Last Name", "Address", "PhoneNo"
            }
        ));
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {tfAddress, tfCustomerID, tfFirstName, tfLastName, tfPhoneNo});
    ...
    private void bAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAddActionPerformed
        ...
        if(!tfCustomerID.getText().trim().equals("")){
            model.addRow(new Object[]{tfCustomerID.getText(),tfFirstName.getText(),tfLastName.getText(),tfAddress.getText(),tfPhoneNo.getText()});
        }else{
