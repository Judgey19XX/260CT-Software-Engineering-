...
public class ShowCustomers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SkiResortPUEntityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("SkiResortPU").createEntityManager();
        customersQuery = java.beans.Beans.isDesignTime() ? null : SkiResortPUEntityManager.createQuery("SELECT c FROM Customers c");
    ...
    private javax.persistence.EntityManager SkiResortPUEntityManager;
    private java.util.List<skiresort.Customers> customersList;
